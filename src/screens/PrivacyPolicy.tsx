...
function PrivacyPolicy() {
  return (
      ...
      <h1>Privacy Policy</h1>
          ...
          <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which are accessible at Tu Lingua unless otherwise defined in this Privacy Policy.</p>
        
          <p className="text-xl font-semibold">Information Collection and Use</p>
          <p>For a better experience, while using our Service, we may require you to provide us with certain personally identifiable information, including but not limited to I do not collect data. The information that we request will be retained by us and used as described in this privacy policy.</p> 
      ...
      <a href="jackbeancode@gmail.com">jackbeancode@gmail.com</a>
      </div>
