...
function Lessons(props:{id?:string;}) {
  ...
  return (
    <Section>
      <GridSection title={converstation.lessons.title} fontcolorsecondary='text-sky-800' id={props.id}
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-6 " >
          ...
          <Link to='/training' children={converstation.landing.continue} align='text-right' secondary_color='text-sky-800'
                state={{
