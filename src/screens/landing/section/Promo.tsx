  ...
  return (
    <Section>
      <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 ">
        <div>
          <div className="h-28 md:h-28 lg:h-96">
            <H1
              children={
                <Typewriter
                  options={{
                    strings: [
                      `${converstation.promo.title}`,
                      `${converstation.promo.title_vietnamese}`,
                    ],
                    autoStart: true,
                    loop: true,
                  }}
          ...
          >
            ...
            {converstation.promo.subtitle.slice(
              56,
              converstation.promo.subtitle.length
            )}
          </H2>
        ...
        <img
          src={converstation.promo.img}
          className="mt-[20%] w-10/12 ml-auto mr-auto mb-auto mt-auto"
          alt="promo image girl play"
        />
      </div>
    </Section>
  );
