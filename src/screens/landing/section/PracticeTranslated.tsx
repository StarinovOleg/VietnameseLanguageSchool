...
function Conversation(props:{id?:string;}) {
  ...
  return (
    <Section>
      <GridSection title={converstation.practice_translate.title} fontcolorsecondary='text-rose-700' id = {props.id} children_header={children_header} onClick={onClick}>
          ...
          <Link to='/training' children={converstation.landing.continue} align='text-right pt-10' secondary_color='text-rose-700'
            state={{
